...
class ClusterICs:
    ...
    def resample_particle_ics(
        self, parts, passive_scalars=None, recalc_mass=False, bkg_density=None, bkg_pressure=None
    ):
        r"""
    ...
    def create_dataset(
        ...
        uniform grid (or, optionally, an AMR grid locally refined around a
        cluster core -- see ``regions``).
        ...
        regions : list of dict, optional
            Locally-refined regions around, e.g., a cluster core -- the same
